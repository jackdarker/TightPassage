...
class _Table_td(container.Container):
    def __init__(self, widget, **params):  #hexpand=0, vexpand=0,
        ...
        self.widget = widget
        params.setdefault('enforceStyleSize',False)
        self.enforceStyleSize =params['enforceStyleSize']
    ...
    def resize(self, width=None, height=None):
        ...
        if (self.enforceStyleSize and self.style.width!=0 and w.rect.w > self.style.width) or (self.enforceStyleSize and self.style.height!=0 and w.rect.h > self.style.height):
            ww, hh = None, None
